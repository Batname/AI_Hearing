...
AI_Hearing-Linux-Debug:
	 $(PROJECTBUILD) AI_Hearing Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

AI_Hearing-Linux-DebugGame:
	 $(PROJECTBUILD) AI_Hearing Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

AI_Hearing-Linux-Shipping:
	 $(PROJECTBUILD) AI_Hearing Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

AI_Hearing-Linux-Test:
	 $(PROJECTBUILD) AI_Hearing Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

AI_Hearing:
	 $(PROJECTBUILD) AI_Hearing Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

AI_HearingEditor-Linux-Debug:
	 $(PROJECTBUILD) AI_HearingEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

AI_HearingEditor-Linux-DebugGame:
	 $(PROJECTBUILD) AI_HearingEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

AI_HearingEditor-Linux-Shipping:
	 $(PROJECTBUILD) AI_HearingEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

AI_HearingEditor-Linux-Test:
	 $(PROJECTBUILD) AI_HearingEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

AI_HearingEditor:
	 $(PROJECTBUILD) AI_HearingEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
