...
AI_HearingRootPath=/media/bat/SecondSSD/Projects/Unreal/AI_Hearing

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/AI_Hearing/AI_Hearing.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(AI_HearingSource.pri)
include(AI_HearingHeader.pri)
include(AI_HearingConfig.pri)
include(AI_HearingIncludes.pri)
include(AI_HearingDefines.pri)
...
AI_Hearing-Linux-Debug.commands = $$build AI_Hearing Linux Debug  -project="\"$$gameProjectFile\"" $$args
AI_Hearing-Linux-DebugGame.commands = $$build AI_Hearing Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
AI_Hearing-Linux-Shipping.commands = $$build AI_Hearing Linux Shipping  -project="\"$$gameProjectFile\"" $$args
AI_Hearing-Linux-Test.commands = $$build AI_Hearing Linux Test  -project="\"$$gameProjectFile\"" $$args
AI_Hearing.commands = $$build AI_Hearing Linux Development  -project="\"$$gameProjectFile\"" $$args

AI_HearingEditor-Linux-Debug.commands = $$build AI_HearingEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
AI_HearingEditor-Linux-DebugGame.commands = $$build AI_HearingEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
AI_HearingEditor-Linux-Shipping.commands = $$build AI_HearingEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
AI_HearingEditor-Linux-Test.commands = $$build AI_HearingEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
AI_HearingEditor.commands = $$build AI_HearingEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	AI_Hearing-Linux-Debug \
	AI_Hearing-Linux-DebugGame \
	AI_Hearing-Linux-Shipping \
	AI_Hearing-Linux-Test \
	AI_Hearing \
	AI_HearingEditor-Linux-Debug \
	AI_HearingEditor-Linux-DebugGame \
	AI_HearingEditor-Linux-Shipping \
	AI_HearingEditor-Linux-Test \
	AI_HearingEditor \
